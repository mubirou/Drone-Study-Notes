...
1. 送信機（[T16IZ Super](https://www.rc.futaba.co.jp/products/detail/I00000332)）の設定
    ...
    1. 「[モード2](https://ds-chiba.jp/2023/06/08/04/)」に変更（ソフトウェア的変更：取説30頁）
        * [システムメニュー]-[ハードウェア設定]-[スティックモード]-[モード2]
    1. 「[モード2](https://ds-chiba.jp/2023/06/08/04/)」に変更（物理的変更：取説30頁）
        * 「[フルスプリング](https://www.rc.futaba.co.jp/support/faq/?cat=98)」仕様に変更
